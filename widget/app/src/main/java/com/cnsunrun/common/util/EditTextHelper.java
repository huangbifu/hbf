...
//        editText. setFilters(new InputFilter[] { new InputFilter.LengthFilter(maxNumber) });
    ...
    /**
     * 输入框 搜索监听
     * @param editSearch 输入框
     * @param needChange 输入框内容改变是否触发搜索回调
     * @param callback 搜索回调
     */
    public static void editSearchListener(final EditText editSearch, boolean needChange, final OnSearchCallback callback){
        editSearch.setOnEditorActionListener(new TextView.OnEditorActionListener() {
            @Override
            public boolean onEditorAction(TextView v, int actionId, KeyEvent event) {
                if (actionId == EditorInfo.IME_ACTION_SEARCH) {
                    //搜索
                    callback.onSearch(editSearch,editSearch.getText().toString());
                }
                return true;
            }
        });
    ...
    public interface OnSearchCallback{
        void onSearch(EditText editSearch,String keyword);
    }
}
