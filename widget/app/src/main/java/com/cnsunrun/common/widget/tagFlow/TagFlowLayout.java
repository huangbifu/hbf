...
public class TagFlowLayout extends FlowLayout implements TagAdapter.OnDataChangedListener {
    ...
    private com.zhy.view.flowlayout.TagFlowLayout.OnSelectListener mOnSelectListener;
    ...
    private void changeAdapter() {
        ...
        TreeSet preCheckedList = mTagAdapter.getPreCheckedList();
...
//            lp.rightMargin = clp.rightMargin;
    ...
    public TreeSet<Integer> getSelectedList() {
        return new TreeSet<Integer>(mSelectedView);
    }
