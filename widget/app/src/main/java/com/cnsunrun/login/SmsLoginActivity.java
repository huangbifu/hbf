 ...
 * 短信登录
 */
public class SmsLoginActivity extends LBaseActivity {
...
//                finish();
    ...
    public void nofityUpdate(int requestCode, BaseBean bean) {
        switch (requestCode) {
            case BaseQuestConfig.QUEST_GET_SMS_LOGIN_VERIFICATION_CODE:
                if (bean.status > 0) {
                    //获取短信验证码
                ...
                break;
            case BaseQuestConfig.QUEST_SMS_LOGIN_CODE:
                if (bean.status > 0) {
                    //短信登录
    ...
    @OnClick({ R.id.get_verification_code,R.id.tv_login,R.id.tv_password_login})
...
//                }
                ...
                if (task == null) {
                    ...
                    BaseQuestStart.getSmsLoginVerificationCode(that, editAccount.getText().toString(), editPicCode.getText().toString());
                }
                break;
            case R.id.tv_login:
                //短信登录
...
//                }
                ...
                BaseQuestStart.smsLogin(that, editAccount.getText().toString(), editVerificationCode.getText().toString());
                break;
